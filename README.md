...
Next, we setup the make_prob.sh. Download the script and paste it in the Scripts folder. Give it permissions to run using the code provided above. Then again setup the aliases
correctly as pointed out earlier.
